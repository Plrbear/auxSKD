...
class R2Plus1DNet(nn.Module):
    ...
    def __init__(self, layer_sizes=(1,1,1,1), block_type=SpatioTemporalResBlock, num_classes=4, num_classes_segment=3, multi_out=True):
        super(R2Plus1DNet, self).__init__()
        self.num_classes = num_classes
        self.num_classes_segment = num_classes_segment
